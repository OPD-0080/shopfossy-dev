                            ...
                            <div class="prof-description">
                                ...
                                <div class="description-content prof-i" data-i="3">
                                    <div class="des-content">
                                        <div class="des.row des-text"> ${array.description} </div>
                                        <div class="des.row des-table">
                                        <table>
                                            <thead>
                                                <tr>
                                                    <th> Parameters </th>
                                            ...
                                            <tbody class="des-table-body">
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_1} </td>
                                                    <td class="details"> ${array.tb_det_1} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_2} </td>
                                                    <td class="details"> ${array.tb_det_2} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_3} </td>
                                                    <td class="details"> ${array.tb_det_3} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_4} </td>
                                                    <td class="details"> ${array.tb_det_4} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_5} </td>
                                                    <td class="details"> ${array.tb_det_5} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_6} </td>
                                                    <td class="details"> ${array.tb_det_6} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_7} </td>
                                                    <td class="details"> ${array.tb_det_7} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_8} </td>
                                                    <td class="details"> ${array.tb_det_8} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_9} </td>
                                                    <td class="details"> ${array.tb_det_9} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_10} </td>
                                                    <td class="details"> ${array.tb_det_10} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_11} </td>
                                                    <td class="details"> ${array.tb_det_11} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_12} </td>
                                                    <td class="details"> ${array.tb_det_12} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_13} </td>
                                                    <td class="details"> ${array.tb_det_13} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_14} </td>
                                                    <td class="details"> ${array.tb_det_14} </td>
                                                </tr>
                                                <tr>
                                                    <td class="parameters"> ${array.tb_para_15} </td>
                                                    <td class="details"> ${array.tb_det_15} </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        </div>
